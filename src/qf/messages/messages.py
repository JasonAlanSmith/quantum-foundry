...
MESSAGES: Final[dict[str, str]] = {
    ...
    "err.utils.config.dir_create_fail": "Could not create data dir for qf: {path}.",
    ...
    "cli.help.prj.manage": "Manage Quantum Foundry projects",
    "cli.help.prj.set_root": "Set the root directory containing Quantum Foundry projects",
    "cli.help.prj.init": "Initialize a new Quantum Foundry project",
    "cli.help.prj.list": "List all Quantum Foundry projects in projects root directory",
    "cli.help.insp": "Inspect a data source",
    "cli.help.insp.project": "Quantum Foundry project name or path",
